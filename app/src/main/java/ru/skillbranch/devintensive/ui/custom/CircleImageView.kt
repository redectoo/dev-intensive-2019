...
class CircleImageView @JvmOverloads constructor (
    ...
    init{
        ...
        if (attrs != null){
            ...
            val a = context.obtainStyledAttributes(attrs, R.styleable.CircleImageView3, defStyleAttr, 0)
            ...
            mCircleBackgroundColor =
                a.getColor(R.styleable.CircleImageView3_civ_circle_background_color, DEFAULT_CIRCLE_BACKGROUND_COLOR)
